      ...
      <div className={styles['careers-hero__container']}>
        ...
        <div className="text-center mb-12 relative z-10">
          <h1
            ...
            className="text-3xl sm:text-4xl lg:text-[40px] text-merriweather font-bold text-(--rs-primary-600) mb-4"
          >
            Explore Leadership Opportunities
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-(--rs-neutral-600) max-w-6xl mx-auto">
            Find your next impactful role or join our talent network for future
            opportunities always with discretion.
          </p>
          <p className="text-sm text-(--rs-neutral-400) mt-2">
        ...
        <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row gap-4 justify-center mb-8 px-4">
          ...
          <Link
            ...
            className="w-full max-w-147.5 mx-auto lg:mx-0"
          >
            <button className="w-full bg-(--rs-neutral-100) text-(--rs-neutral-600) px-6 sm:px-8 py-3 rounded-lg font-semibold text-[18px] sm:text-[20px] lg:text-[22px] border-2 border-(--rs-neutral-400) hover:bg-(--rs-neutral-200) transition flex items-center justify-center gap-2">
              <Image
                src="/images/careers/human.png"
                alt=""
                width={27.5}
                height={27.5}
                className="w-6 h-6 sm:w-[27.5px] sm:h-[27.5px]"
          ...
          <div className="w-full max-w-147.5 mx-auto lg:mx-0">
            <button
              onClick={handleOpenJobsSidebar}
              className="w-full bg-(--rs-primary-500) text-(--rs-primary-100) px-6 sm:px-8 py-3 rounded-lg font-semibold text-[18px] sm:text-[20px] lg:text-[22px] border-2 border-(--rs-primary-600) hover:bg-(--rs-primary-600) transition flex items-center justify-center gap-2"
            >
              <Image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="text-[28px] items-center font-bold text-(--rs-primary-600) mb-6 text-merriweather">
              What We&apos;re Looking For
            </h3>
            <div className="space-y-6 text-[20px]">
              <div className="flex items-center gap-2">
                ...
                <p className="text-(--rs-neutral-900) leading-relaxed">
          ...
          <div className="text-[20px]">
            <h3 className="text-[28px] font-bold text-(--rs-primary-600) mb-6 text-merriweather">
              What We Love
            </h3>
            <p className="text-(--rs-neutral-900) mb-6 leading-relaxed">
