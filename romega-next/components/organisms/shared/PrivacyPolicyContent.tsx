...
export default function PrivacyPolicyContent({
  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      >
        This Applicant Data Privacy and Consent Policy explains how Romega Solutions
        collects, processes, stores, retains, and shares applicant and professional
        information for recruitment, engagement, and talent matching purposes.
      </p>
      ...
      <p className="text-gray-700 mb-3" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        We collect personal and professional information voluntarily provided by applicants,
        candidates, and contacts through website forms, recruitment workflows, and related channels.
      </p>
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        ...
        <li>Professional profile links (for example LinkedIn or portfolio pages)</li>
      </ul>
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        ...
        <li>Client and project matching based on relevant professional qualifications (when consented)</li>
        <li>Public talent showcase publication only with separate explicit publication consent</li>
      </ul>
      ...
      <p className="text-gray-700 mb-3" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        We retain data only for a reasonable period necessary for recruitment, matching,
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        ...
        <li>Applicants may request deletion or removal, subject to legal limitations</li>
      </ul>
      ...
      <p className="text-gray-700 mb-3" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        We disclose only what is necessary and relevant for evaluation and matching.
      </p>
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        <li>Authorized internal personnel involved in recruitment and staffing</li>
        <li>Potential clients or partners for role/project matching with applicant consent</li>
      ...
      <p className="text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        Sensitive information not required for evaluation is not shared without additional consent.
      </p>
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        ...
        <li>Access is limited to authorized personnel with confidentiality responsibilities</li>
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-6" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        ...
        <li>Request deletion, blocking, or removal subject to legal and operational limits</li>
      </ul>
      ...
      <p className="text-gray-700 mb-2" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        For access, correction, withdrawal, deletion, and takedown requests, contact:
      </p>
      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
        ...
        <p className="text-gray-700 mb-0" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
          Address: 222 Pacific Coast Hwy, #10, El Segundo, CA 90245
        </p>
      </div>

      <p className="text-gray-700 mb-0" style={{ fontFamily: 'var(--font-sans), "Source Sans 3", sans-serif' }}>
        Target internal response timeline for privacy and takedown requests: within {PRIVACY_REQUEST_SLA_BUSINESS_DAYS} business days.
      </p>
